package local.tobbstr.demos.cleanarch.todo_in_spring.infrastructure.persistence;
...
import local.tobbstr.demos.cleanarch.todo_in_spring.infrastructure.persistence.spring.data_jpa.TaskHibernateEntity;
import local.tobbstr.demos.cleanarch.todo_in_spring.infrastructure.persistence.spring.data_jpa.TaskJpaRepository;
import local.tobbstr.demos.cleanarch.todo_in_spring.infrastructure.persistence.spring.data_jpa.TodoHibernateEntity;
import local.tobbstr.demos.cleanarch.todo_in_spring.infrastructure.persistence.spring.data_jpa.TodoJpaRepository;
